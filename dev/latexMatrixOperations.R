#' Arithmetic and Other Operations on \code{"latexMatrix"} Objects
#' 
#' @description
#' 
...
#' @param numeric if \code{TRUE} (the default) and the matrices to be multiplied can be
...
#' @returns All of these functions return \code{"latexMatrix"} object, 
