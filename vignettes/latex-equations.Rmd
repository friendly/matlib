...
features (equation numbers and references, horizontal and vertical lines for partitioned matrices) **do not work** in this vignette as rendered by [`pkgdown`](https://pkgdown.r-lib.org/), as far as we can determine.
...
### Partititioned matrices, indexing & binding
...
structure. For example, the code below represents a $4 \times 4$ matrix
