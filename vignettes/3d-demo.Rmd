...
Start with a unit cube, representing the identity matrix. 
...
```{r matrix-A}
# matrix A: 
A <- matrix(c( 1, 0, 1, 0, 2, 0,  1, 0, 2), 3, 3) |> print()
det(A)
...
[drawing a cube with colored faces, vertex points and lines](http://stackoverflow.com/questions/39730889/rgl-drawing-a-cube-with-colored-faces-vertex-points-and-lines).
